...
const DEFAULT_ICONS = {
    close: '<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="4" x2="12" y2="12"/><line x1="12" y1="4" x2="4" y2="12"/></svg>',
...
class Lightbox {
    ...
    close() {
        ...
        const closeWhenInvisible = (s) => s.opacity < 0.01;
    ...
    dismissClose(velocityX, velocityY) {
        ...
        if (!thumbRect || !this.isInViewport(thumbRect)) {
            this.animateSpring({
                ...
                crop: 0,
                borderRadius: currentBR,
            }, this.opts.springClose, () => this.finishClose(), (s) => s.opacity < 0.01, { translateX: velocityX, translateY: velocityY });
            return;
        }
        ...
        const atThumbnail = (s) => Math.abs(s.scale - flipScale) < 0.05 &&
